...
- (void)layoutSubviews {
    ...
    if (SYSTEM_VERSION < 7) {
       ...
       detailsLabelSize = [detailsLabel.text sizeWithFont:detailsLabel.font
        ...
        CGRect detailsLableRect = [detailsLabel.text boundingRectWithSize:maxSize options:(NSStringDrawingUsesFontLeading|NSStringDrawingUsesLineFragmentOrigin) attributes:attributes context:nil];
        
        detailsLabelSize = detailsLableRect.size;
    }
